/* ==========================================================
   dceeny.com — translations.js (CLEAN)
   Responsibilities:
   - Store translation dictionary (translations)
   - Provide `applyTranslations(lang)` and `switchLanguage(lang)`
   - Apply translations to:
       * elements with [data-translate]
       * placeholders with [data-placeholder]
       * <meta ... data-translate="key"> (content)
       * <title data-translate="key"> (document.title)
   - Set document direction + language + font classes
   Notes:
   - Client-side translated <title>/<meta> helps UX, but SEO crawlers may not
     index those translated values unless you also provide language-specific URLs.
========================================================== */
...
(() => {
  ...
  const translations = {
    en: {
      ...
      tamechitInfo:
        "Type: interior | Location: Tamechit, Batna | Surface: 9 m²",
      aliSurf: "- 9 m² -",
      riyadhInfo: "Type: interior | Location: Riyadh, Batna | Surface: 80 m²",
      aliInfo:
      ...
      citySurf: "- 43 m² -",
      cityInfo:
        "Type: interior | Location: City Kouba, Annaba | Surface: 43 m²",
      alger: "Algiers",
      annaba: "Annaba",
      cheraga: "Chéraga",
      cheragaSurf: "- 17 m² -",
      cheragaInfo:
        "Type: interior | Location: Chéraga, Algiers | Surface: 17 m²",
      oran: "Oran",
      ...
      bl1Ex:
        "Practical Exercise: Create a new project and import a scaled plan",
      ...
      bl5Ex:
        "Practical Exercise: Create two photorealistic renders (day/night)",
      ...
      bl6Ex:
        "Practical Exercise: Retouch and finalize renders + short animation",
      ...
      rvSkill2:
        "Organization and management of families, materials, and levels",
      ...
      acResult1:
        "Design, model, and document a complete architectural project.",
      ...
      sk6_3:
        "Management of materials and object names for good synchronization",
      ...
      d5s1_1:
        "Presentation of the interface, shortcuts, and SketchUp workflow.",
      d5s1_2: "Units, model configuration, and organization methods.",
      d5s1_3:
        "Essential tools: Line, Rectangle, Push/Pull, Move, Rotate, Scale.",
      ...
      d5s4_3:
        "Materials in D5: Application, adjustment, displacement, and PBR.",
      ...
      revitObj5:
        "Apply advanced rendering techniques for photorealistic images.",
      revitObj6:
      ...
      revitS4Title:
        "Session 4: Introduction to D5 Render - Interface & Workflow",
      revitS4_1:
      ...
      acadsObj6:
        "Understand the 3D environment and basic solid modeling tools.",
      ...
      acadsS2_3:
        "Polylines and Splines: advanced creation, thickness, joining.",
      ...
      acadsS3Ex:
        "Exercise: Insertion of furniture + complete plan dimensioning.",
      ...
      acadsS4_4:
        "Printing/Plotting: plot styles, line weights, PDF/DWG export.",
      acadsS4Ex:
      ...
      ac2dObj1:
        "Discover the AutoCAD environment and master fundamental tools.",
      ac2dObj2:
      ...
      ac2dS1_3:
        "Drawing tools: line, polyline, circle, arc, rectangle, ellipse.",
      ac2dS1_4:
      ...
      rhd5S1_1:
        "Presentation of the interface, navigation, and essential tools.",
      ...
      rhd5S5_4:
        "Final adjustments: colors, contrast, and project presentation.",
      ...
      dsmaxcr:
        "3Ds Max & Corona Renderer - From Modeling to Realistic Rendering",
    ...
    fr: {
      ...
      sampleApproval:
        "Approbation des échantillons et des nuanciers de peinture",
      ...
      ac2_3:
        "Introduction aux outils de forme libre et aux toitures complexes.",
      ...
      sk1_4:
        "Organisation du projet dès le départ (dossiers, textures, formats)",
      ...
      sk8_3:
        "Création d'un environnement réaliste : terrain, routes, végétation",
      sk8_4:
      ...
      d5s4_3:
        "Matériaux dans D5 : Application, ajustement, déplacement et PBR.",
      ...
      d5s5_3:
        "Raffinement des matériaux (verre, métaux, tissus, marbre, bois).",
      ...
      rvb1Ex:
        "EXERCICE : MODÉLISER UNE PETITE PIÈCE (SOL + 4 MURS + OUVERTURE).",
      ...
      acObj6:
        "Finaliser un projet complet de la modélisation à la publication.",
      ...
      revitS4Title:
        "Séance 4 : Introduction à D5 Render - Interface et workflow",
      revitS4_1:
      ...
      acadsS2_3:
        "Polylignes et Splines : Création avancée, épaisseur, jointure.",
      acadsS2_4:
      ...
      acadsS3_2:
        "Références externes (XREF) : Attachement de fichiers DWG/PDF.",
      ...
      acadsS4_3:
        "Cartouche : Insertion, personnalisation, bloc d'informations.",
      acadsS4_4:
      ...
      ac2dBonus1:
        "Bibliothèque AutoCAD (portes, fenêtres, mobilier, symboles).",
      ac2dBonus2: "Gabarits de plans et fichiers de calques types.",
      ac2dBonus3:
        "Fichier pour les styles de texte, de cotation et de hachures.",
      ac2dBonus4:
      ...
      rhd5Obj2:
        "Acquérir une méthodologie de travail fluide et professionnelle.",
      rhd5Obj3:
      ...
      rhd5S1_2:
        "Paramétrage du projet architectural (unités, calques, gabarits)",
      ...
      rhd5S3_2:
        "Utilisation des calques et noms d'objets pour un workflow clair",
      ...
      dsmaxcrsub:
        "Flux de travail complet pour la visualisation architecturale",
      dsmaxcrdesc:
      ...
      ch2_3:
        "Premiers pas pour naviguer et utiliser la plateforme correctement",
      ch3Title:
        "Chapitre 3 — Préparation du flux de travail (Revit + SketchUp)",
      ...
      ch8_5:
        "Modèles de flux de travail prédéfinis pour accélérer votre travail",
      aiRenderPriceOld: "12000 DA",
      aiRenderPriceNew: "5999 DA",
    },
    ...
    ar: {
      ...
      kualaSurf: "-  70 م² -",
      kualaInfo:
        "النوع: داخلية | المنطقة: كوالالمبور، ماليزيا | المساحة: 75 م²",
      privateKuala: "مطعم - كوالالمبور",
      ksa: "السعودية",
      riyadhh: "الرياض",
      riyadhhSurf: "-  130 م² -",
      riyadhhInfo:
        "النوع: داخلية | المنطقة: الرياض، السعودية | المساحة: 130 م²",
      ...
      kantaraTwoSurf: "- 25 م² -",
      kantaraTwoInfo:
        "النوع: داخلية | المنطقة: القنطرة، بسكرة | المساحة: 25 م²",

      bouzourane: "بوزوران",
      bouzouraneSurf: "- 30 م² -",
      bouzouraneInfo:
        "النوع: داخلية | المنطقة: بوزوران، باتنة | المساحة: 30 م²",
      ...
      ainToutaSurf: "- 30 م² -",
      ainToutaInfo:
        "النوع: داخلية | المنطقة: عين التوتة، باتنة | المساحة: 30 م²",

      tazoultTwo: " -2- تازولت",
      tazoultTwoSurf: "- 400 م² -",
      tazoultTwoInfo:
        "النوع: خارجية | المنطقة: تازولت، باتنة | المساحة: 400 م²",

      privateIndonesiaa: "شقة خاصة - إندونيسيا",
      jakarta: "جاكارتا",
      jakartaSurf: "- 70 م² -",
      jakartaInfo:
        "النوع: داخلية | المنطقة: جاكارتا، إندونيسيا | المساحة: 70 م²",
      ...
      learningDesc:
        "دورات تدريبية وتعليم من أحد أفضل استوديوهات التصميم الداخلي",

      dontforget: "لا تنسَ الاطلاع على مشاريعنا!",

      // saunaAnnabaInfo:"Type: interior | Location: Annaba, Algeria | Surface: 60 m²",
      saunaAnnabaInfo:
        "النوع: داخلية | المنطقة: عنابة، الجزائر | المساحة: 60 م²",
      ...
      azerbaijanInfo:
        "النوع: داخلية | المنطقة: أذربيجان، باكو | المساحة: 50 م²",
      ...
      publicbatnaInfo:
        "النوع: داخلية | المنطقة: باتنة، الجزائر | المساحة: 23 م²",
      batnaSurf: "- 23 م² -",
      ...
      blenderSubtitle:
        "أتقن النمذجة والخامات والإضاءة المعمارية باستخدام بلندر.",
      blenderDescription:
      ...
      sk3_4:
        "استيراد مخططات DWG واستخدام إضافات العمارة (Dibac, 1001bit, etc.)",
      ...
      d5s5_2:
        "إعدادات الكاميرا (البعد البؤري/التعريض/عمق المجال/توازن البياض).",
      ...
      rvb3_3:
        "3. مواد V-Ray الأساسية: قياسية، معدن بسيط، خشب أساسي، زجاج بسيط.",
      ...
      acadsObj6:
        "فهم البيئة ثلاثية الأبعاد وأدوات نمذجة المواد الصلبة الأساسية.",
      ...
      buy_now: "اشترِ الآن",
      aiRenderTitle:
        "إتقان الرندر بالذكاء الاصطناعي: حول نماذج SketchUp/Revit إلى رندر واقعي",
      aiRenderShortDesc:
  ...
  function getSavedLanguage() {
    try {
      const lang = localStorage.getItem(STORAGE_LANG_KEY) || "en";
  ...
  function setLanguageDirection(lang) {
    ...
    root.setAttribute("lang", isArabic ? "ar" : lang);

    // classes for your CSS (.ltr/.rtl + .font-en/.font-fr/.font-ar)
    body.classList.remove("ltr", "rtl", "font-en", "font-fr", "font-ar");
    body.classList.add(isArabic ? "rtl" : "ltr");
    if (lang === "en") body.classList.add("font-en");
    if (lang === "fr") body.classList.add("font-fr");
    if (lang === "ar") body.classList.add("font-ar");

    // Inputs direction consistency
  ...
  function applyHeadTranslations(lang) {
    ...
    if (titleEl) {
      ...
      const value = key ? translateString(lang, key) : null;
      if (value) document.title = value;
    }

    // <meta ... data-translate="..."> sets content="..."
  ...
  function applyBodyTranslations(lang) {
    ...
    elements.forEach((element) => {
      ...
      const value = translateString(lang, key);
      if (!value) return;

      // Allow \n in translation values
      const translatedHtml = String(value).replace(/\n/g, "<br>");
      ...
      // <select> placeholder option logic
      if (
    ...
    // Handle <option> elements inside <select>
    document
      .querySelectorAll("select option[data-translate]")
      .forEach((option) => {
  ...
  function updateLanguageButtonLabel(lang) {
    // Header is injected: button may not exist at page load.
    const btn = document.getElementById("lge-btn");
    if (btn) btn.textContent = String(lang).toUpperCase();
  }

  function applyTranslations(lang) {
    const safeLang = SUPPORTED_LANGS.includes(lang) ? lang : "en";
    applyHeadTranslations(safeLang);
    applyBodyTranslations(safeLang);
    setLanguageDirection(safeLang);
    updateLanguageButtonLabel(safeLang);
  }
  ...
  // Expose functions used by layout.js and other scripts
  ...
  // When header/footer are injected, re-run (to translate injected content + update button label)
  window.addEventListener("dceeny:layout-ready", () => {
    applyTranslations(getSavedLanguage());
  });
})();
